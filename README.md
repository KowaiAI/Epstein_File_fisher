...
## 🌟 **IMPORTANT: Two Download Methods Available**

### Method 1: CSV Downloader (RECOMMENDED) ⭐
Uses a CSV file with direct download links. **No bot detection issues!**
- ✅ Reliable and fast
- ✅ Works every time
- ✅ Same interactive menu
- 📖 [See CSV Method Guide](CSV_METHOD.txt)

### Method 2: Web Scraper
Scrapes the website directly. May have bot detection issues.
- ⚠️ Bot detection can block pagination
- ⚠️ Less reliable
...
```bash
# Run with interactive menu - select data sets from a menu!
python scraper.py
```
...
# Recommended for testing (just Data Set 1)
...
📖 **[See Interactive Menu Guide](INTERACTIVE_MENU.txt)** for detailed instructions
